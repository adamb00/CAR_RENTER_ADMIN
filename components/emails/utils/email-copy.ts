...
export const EMAIL_COPY: Record<string, EmailCopy> = {
  ...
  de: {
    ...
    paymentNote: 'Die Bezahlung ist in bar oder mit Bankkarte möglich.',
  ...
  ro: {
    ...
    paymentNote: 'Plata se poate efectua în numerar sau cu card bancar.',
  ...
  fr: {
    ...
    paymentNote: 'Le paiement est possible en espèces ou par carte bancaire.',
  ...
  es: {
    ...
    paymentNote: 'El pago puede realizarse en efectivo o con tarjeta bancaria.',
  ...
  it: {
    ...
    paymentNote: 'Il pagamento è possibile in contanti o con carta bancaria.',
  ...
  sk: {
    ...
    paymentNote: 'Platba je možná v hotovosti alebo bankovou kartou.',
  ...
  cz: {
    ...
    paymentNote: 'Platba je možná v hotovosti nebo bankovní kartou.',
  ...
  se: {
    ...
    paymentNote: 'Betalning kan göras kontant eller med bankkort.',
  ...
  no: {
    ...
    paymentNote: 'Betaling kan gjøres kontant eller med bankkort.',
  ...
  dk: {
    ...
    paymentNote: 'Betaling kan ske kontant eller med betalingskort.',
  ...
  pl: {
    ...
    paymentNote: 'Płatność jest możliwa gotówką lub kartą bankową.',
